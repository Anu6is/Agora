...
namespace Agora.Discord.Commands
{
    ...
    public class CreateAuctionModule : AgoraModuleBase
    {
        [Group("Standard")]
        public class StandardAuctionModule : AgoraModuleBase
        {            
            [Command("Auction")]
            public async Task CreateStandarAuction(
                ...
                [Description("Amount by which bids must increase. Defaults to 1")] decimal minBidIncrease = 1,
        ...
        [Group("Sealed")]
        public class VickreyAuctionModule : AgoraModuleBase
        {
            [Command("Auction")]
                ...
                [Description("True to hide the item owner.")] bool anonymous = false)
            {
                ...
                await ExecuteAsync(new CreateVickreyAuctionCommand(showroom, item, listing));
